            ...
            <div class="row content">
                ...
                <div class="col-sm-12 text-center"> 
                    ...
                    <form onsubmit="return validar_busqueda_cedula()" action="../modulos_administrador/adm_ejecutar_buscar_estudiantes.php" method="post" enctype="multipart/form-data">
                        <div class="col-md-3">
                            <a href="adm_buscar_estudiantes.php">Regresar</a>
                        </div>
                    ...
                    $statement = 'select u.*,e.nombres, e.apellidos, e.ci from usuario as u, estudiante as e where u.idUsuario=e.id_usuario';
                    $clausula_where = '';
                    switch ($criterio) {
                        case 'nombre':
                            $clausula_where = ' and (e.nombres like "%' . $valor_criterio . '%"  or e.apellidos like "%' . $valor_criterio . '%")';
                        ...
                        case 'usuario':
                            ...
                            break;
                        case 'cedula':
                            $clausula_where = ' and e.ci= "' . $valor_criterio . '"';
                            $statement = $statement . $clausula_where;
                            break;
                    }
